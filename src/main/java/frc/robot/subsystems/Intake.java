...
public class Intake extends SubsystemBase {
  ...
  private final SparkMax m_leftArm; // NEO make a pid for position that only allows the arm to go down 90?
  ...
  public Intake() {
    ...
    m_leftArm.configure(m_armConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
    m_rightArm.configure(m_armConfig.follow(CanIdsOtherThanDrive.kLeftArmId,true),ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
